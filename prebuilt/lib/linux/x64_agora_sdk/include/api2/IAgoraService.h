...
class IAgoraService {
 public:
   ...
   * ADM usage.
   *
   * @param enabled Whether or not to start recording:
   * - `true`: (Default) Start recording the local audio.
   * - `false`: Do not record the local audio.
   * @return
   ...
   */
  virtual agora_refptr<rtc::ILocalAudioTrack> createLocalAudioTrack(bool enabled = true) = 0;
