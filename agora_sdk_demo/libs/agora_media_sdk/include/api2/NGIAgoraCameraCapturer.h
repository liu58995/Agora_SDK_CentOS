 ...
 public:
  ...
  class IDeviceInfo {
   public:
    ...
    /**
     * Gets the index number of all available cameras.
     * @return
     * - The index number of all available cameras.
     */
     ...
     * @param deviceUniqueId The unique ID of the device, if any.
     * @param deviceUniqueIdLength The length of the device ID, if any.
     * @param productUniqueId The unique ID of the product, if any.
     ...
     */
    virtual int32_t GetDeviceName(uint32_t deviceNumber, char* deviceName,
                                  uint32_t deviceNameLength, char* deviceUniqueId,
                                  uint32_t deviceUniqueIdLength, char* productUniqueId = 0,
