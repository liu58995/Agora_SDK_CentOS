...
/** This method register an extension provider to factory
 */
AGORA_API int AGORA_CALL registerMediaNodeProvider(
    const char* vendor_name, agora::agora_refptr<agora::rtc::IMediaNodeProvider> provider);

/** This method unregister an extension provider from factory
 */
AGORA_API int AGORA_CALL unregisterMediaNodeProvider(const char* vendor_name);
